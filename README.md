...
Current Android build: **3.1.16 (5075)**. This build includes on-device Storage saver backup quality, separate compression/upload progress, the corrected native JNI bridge, and the mandatory Inhouse update gate.
