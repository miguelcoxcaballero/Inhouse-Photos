package com.inhousesoftware.photos.widget
...
import com.inhousesoftware.photos.R
import com.inhousesoftware.photos.widget.model.*
import java.io.File
          ...
          Column(
            ...
            if (widgetState == WidgetState.LOG_IN.toString()) {
              Box(
                ...
                Text("Log in to your Inhouse Photos server", style = TextStyle(textAlign = TextAlign.Center, color = GlanceTheme.colors.primary))
              }
            } else {
              Row(
                verticalAlignment = Alignment.CenterVertically,
