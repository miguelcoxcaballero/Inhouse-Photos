...
export default function Home() {
 ...
 <article><span className="platform">02 / EN CASA</span><h2>Windows</h2><p>Tu servidor existente, en una app. Vinculación verificada, almacenamiento e inicio automático al entrar en Windows.</p><a className="download secondary" href={releases+'/download/server-v1.0.0/Inhouse-Photos-Server-Setup.exe'}>Descargar para Windows <span aria-hidden>↓</span></a><small>Windows 10 / 11 · Versión 1.0 · Instalador para servidores existentes</small><small>No cambia tus fotos ni tus cuentas. No prepara todavía un servidor desde cero. Ejecutable sin firma digital; mantén las protecciones de Windows activadas.</small><small><a href={releases+'/download/server-v1.0.0/SHA256SUMS.txt'}>Verificar instalador ↗</a></small></article>
