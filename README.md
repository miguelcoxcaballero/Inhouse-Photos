...
Current Android build: **3.1.17 (5076)**. This build includes on-device Storage saver backup quality, deduplicated local/server timeline assets, separate compression/upload progress, the corrected native JNI bridge, and the mandatory Inhouse update gate.
