...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "com.inhousesoftware.photos.background.refreshUpload"
  private static let processingTaskID = "com.inhousesoftware.photos.background.processingUpload"
