...
class AppConfig {
  ...
  T read<T>(SettingsKey<T> key) =>
      (switch (key) {
            ...
            .imageCacheMode => image.cacheMode,
            ...
            .albumOfflineIds => album.offlineAlbumIds,
            ...
            .backupQuality => backup.quality,
            .backupSpeed => backup.speed,
            .backupUploadedOriginalBytes => backup.uploadedOriginalBytes,
            .backupStoredBytes => backup.storedBytes,
  ...
  AppConfig write<T, U extends T>(SettingsKey<T> key, U value) {
    return switch (key) {
      ...
      .imageCacheMode => copyWith(image: image.copyWith(cacheMode: value as ImageCacheMode)),
      ...
      .albumOfflineIds => copyWith(album: album.copyWith(offlineAlbumIds: value as List<String>)),
      ...
      .backupQuality => copyWith(backup: backup.copyWith(quality: value as BackupQuality)),
      .backupSpeed => copyWith(backup: backup.copyWith(speed: value as BackupSpeedMode)),
      .backupUploadedOriginalBytes => copyWith(backup: backup.copyWith(uploadedOriginalBytes: value as int)),
      .backupStoredBytes => copyWith(backup: backup.copyWith(storedBytes: value as int)),
