...
Current Android build: **3.1.13 (5072)**. This build includes on-device Storage saver backup quality, the corrected native JNI bridge, and the mandatory Inhouse update gate.
