...
abstract class $Drift extends i0.GeneratedDatabase {
  ...
  late final i5.$RemoteAssetCloudIdEntityTable remoteAssetCloudIdEntity = i5
  ...
  List<i0.DatabaseSchemaEntity> get allSchemaEntities => [
    ...
    i5.idxRemoteAssetCloudId,
    i8.idxLocalAlbumAssetAlbumAsset,
    ...
    i2.idxRemoteAssetOwnerVisibilityDeletedLocalDateTime,
    authUserEntity,
    userMetadataEntity,
    partnerEntity,
    remoteExifEntity,
    ...
    settingsEntity,
    assetOcrEntity,
    i11.idxPartnerSharedWithId,
    i12.idxLatLng,
    i12.idxRemoteExifCity,
    i13.idxRemoteAlbumAssetAlbumAsset,
...
class $DriftManager {
  ...
  i5.$$RemoteAssetCloudIdEntityTableTableManager get remoteAssetCloudIdEntity =>
      i5.$$RemoteAssetCloudIdEntityTableTableManager(
        _db,
