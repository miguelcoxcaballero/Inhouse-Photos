...
final class Schema33 extends i0.VersionedSchema {
  ...
  late final List<i1.DatabaseSchemaEntity> entities = [
    ...
    idxRemoteAssetOwnerVisibilityDeletedCreated,
    idxRemoteAssetUploaded,
    idxRemoteAssetOwnerVisibilityDeletedLocalDateTime,
    authUserEntity,
    userMetadataEntity,
    partnerEntity,
    remoteExifEntity,
  ...
  final i1.Index idxLocalAssetLocalDateTime = i1.Index(
  ...
  final i1.Index idxRemoteAssetOwnerVisibilityDeletedLocalDateTime = i1.Index(
...
final class Schema34 extends i0.VersionedSchema {
  ...
  final i1.Index idxLocalAssetMissingThumbHash = i1.Index(
