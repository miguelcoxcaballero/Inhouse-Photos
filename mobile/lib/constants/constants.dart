...
const List<(String, String)> kWidgetNames = [
  ('com.inhousesoftware.photos.widget.random', 'com.inhousesoftware.photos.widget.RandomReceiver'),
  ('com.inhousesoftware.photos.widget.memory', 'com.inhousesoftware.photos.widget.MemoryReceiver'),
];
